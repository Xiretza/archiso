...
make_basefs() {
    ...
    setarch ${arch} mkarchiso ${verbose} -w "${work_dir}/${arch}" -C "${work_dir}/pacman.conf" -D "${install_dir}" -p "haveged intel-ucode memtest86+ memtest86-efi mkinitcpio-nfs-utils nbd zsh" install
}
...
make_setup_mkinitcpio() {
    ...
    patch -d ${work_dir}/${arch}/airootfs/etc/initcpio/hooks < ${script_path}/archiso_hook.patch
...
make_efi() {
    ...
    cp ${script_path}/efiboot/loader/entries/memtest-x86_64.conf ${work_dir}/iso/loader/entries/
    
    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        ${script_path}/efiboot/loader/entries/archiso-x86_64-usb.conf > ${work_dir}/iso/loader/entries/archiso-x86_64.conf

    cp ${work_dir}/iso/loader/entries/archiso-x86_64{,-persistent}.conf
    sed -i 's/^title .*/& - Persistent Storage/' ${work_dir}/iso/loader/entries/archiso-x86_64-persistent.conf
    echo "options cow_label=ARCHISO_COW" >> ${work_dir}/iso/loader/entries/archiso-x86_64-persistent.conf

    cp ${work_dir}/iso/loader/entries/archiso-x86_64{,-copytoram}.conf
    sed -i 's/^title .*/& - Copy to RAM/' ${work_dir}/iso/loader/entries/archiso-x86_64-copytoram.conf
    echo "options copytoram" >> ${work_dir}/iso/loader/entries/archiso-x86_64-copytoram.conf
    ...
    cp ${work_dir}/x86_64/airootfs/usr/share/memtest86-efi/bootx64.efi ${work_dir}/iso/EFI/memtest.efi
    cp ${work_dir}/x86_64/airootfs/usr/share/licenses/memtest86-efi/LICENSE.rtf ${work_dir}/iso/EFI/memtest.COPYING
}
...
make_efiboot() {
    ...
    cp ${script_path}/efiboot/loader/entries/memtest-x86_64.conf ${work_dir}/efiboot/loader/entries/

    sed "s|%ARCHISO_LABEL%|${iso_label}|g;
         s|%INSTALL_DIR%|${install_dir}|g" \
        ${script_path}/efiboot/loader/entries/archiso-x86_64-cd.conf > ${work_dir}/efiboot/loader/entries/archiso-x86_64.conf

    cp ${work_dir}/efiboot/loader/entries/archiso-x86_64{,-copytoram}.conf
    sed -i 's/^title .*/& - Copy to RAM/' ${work_dir}/efiboot/loader/entries/archiso-x86_64-copytoram.conf
    echo "options copytoram" >> ${work_dir}/efiboot/loader/entries/archiso-x86_64-copytoram.conf

    cp ${work_dir}/iso/EFI/shellx64_v2.efi ${work_dir}/efiboot/EFI/
    cp ${work_dir}/iso/EFI/shellx64_v1.efi ${work_dir}/efiboot/EFI/

    cp ${work_dir}/iso/EFI/memtest.efi ${work_dir}/efiboot/EFI/
    cp ${work_dir}/iso/EFI/memtest.COPYING ${work_dir}/efiboot/EFI/
